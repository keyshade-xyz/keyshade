  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast:
            'group toast group-[.toaster]:bg-zinc-700 group-[.toaster]:text-white group-[.toaster]:border-white/15 group-[.toaster]:shadow-lg dark:group-[.toaster]:bg-zinc-950 dark:group-[.toaster]:text-zinc-50 dark:group-[.toaster]:border-zinc-800',
          description:
