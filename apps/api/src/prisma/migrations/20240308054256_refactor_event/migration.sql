/*
  ...
  - The values [API_KEY_UPDATED,API_KEY_DELETED,API_KEY_ADDED,USER_UPDATED] on the enum `EventType` will be removed. If these variants are still used in the database, this will fail.
