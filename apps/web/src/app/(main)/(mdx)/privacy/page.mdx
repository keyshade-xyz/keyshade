...
<span style={{ textDecoration: 'underline' }}>Withdrawing your consent:</span>If
we are relying on your consent to process your personal information, which may
...
time by contacting us by using the contact details provided in the section "HOW
