...
const zodEnv = z.object({
  NEXT_PUBLIC_GOOGLE_ANALYTICS_MEASUREMENT_ID: z.string().url(),
  NEXT_PUBLIC_SENTRY_WEB_DSN: z.string().url().optional(),
  NEXT_PUBLIC_SENTRY_WEB_PROFILE_SAMPLE_RATE: sampleRateSchema(
    'NEXT_PUBLIC_SENTRY_WEB_PROFILE_SAMPLE_RATE'
  ),
