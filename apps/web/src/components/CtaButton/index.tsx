...
export default function CtaButton({
  ...
  return (
    <button
      className={`${geistMono.className} relative m-1 flex w-full gap-1 overflow-hidden rounded-xl border-4 border-[#0B3038] bg-[#0B798C] bg-gradient-to-b from-white/[6%] to-transparent px-3 py-2 text-[#D4F7FF] shadow-lg shadow-[#005EFC]/[25%] md:w-fit`}
      type="button"
      {...props}
    >
